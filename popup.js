...
function generateModal(project) {
  let htmlText = `<button data-modal-target="#modal" class="orange-button">See Project</button>
                        ...
                        <div class="top-buttons">
                          <ul class="buttons">`;
                            ...
                            for (let i = 0; i < project.technologies.length; i += 1) {
                              ...
                              htmlText += `<li><button type="button" class="button">${project.technologies[i]}</button></li>`;
                            }
                            htmlText += `
                          </ul>
                        </div>              
